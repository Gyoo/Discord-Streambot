...
public class CNotifyTest extends CommandTest{
    ...
    public void testExecuteMe() throws Exception {
        ...
        Assert.assertEquals(1, MessageHandler.getQueue().size());
        Assert.assertEquals(MessageHandler.getQueue().peek().getMessage().getContent(), "You will be mentioned in announces !");
    ...
    public void testExecuteUnknowParam() throws Exception {
        ...
        Assert.assertEquals(1, MessageHandler.getQueue().size());
        Assert.assertEquals(MessageHandler.getQueue().peek().getMessage().getContent(), "Unknown parameter");
    }
    ...
    public void testExecuteMeNot() throws Exception {
        ...
        Assert.assertEquals(1, MessageHandler.getQueue().size());
        Assert.assertEquals(MessageHandler.getQueue().peek().getMessage().getContent(), "You will not be mentioned in announces anymore !");
        list = dao.getAll(NotificationEntity.class);
        Assert.assertEquals(list.size(), 0);
    }
    ...
    public void testExecuteEveryone() throws Exception {
        ...
        Assert.assertEquals(1, MessageHandler.getQueue().size());
        Assert.assertEquals(MessageHandler.getQueue().peek().getMessage().getContent(), "Announces will mention \"everyone\" !");
        list = dao.getAll(NotificationEntity.class);
        Assert.assertEquals(list.size(), 1);
    }
    ...
    public void testExecuteEveryoneNot() throws Exception {
        ...
        Assert.assertEquals(1, MessageHandler.getQueue().size());
        Assert.assertEquals(MessageHandler.getQueue().peek().getMessage().getContent(), "Removed \"everyone\" from announces mentions !");
        list = dao.getAll(NotificationEntity.class);
        Assert.assertEquals(list.size(), 0);
    }
    ...
    public void testExecuteHere() throws Exception {
        ...
        Assert.assertEquals(1, MessageHandler.getQueue().size());
        Assert.assertEquals(MessageHandler.getQueue().peek().getMessage().getContent(), "Announces will mention \"here\" !");
        list = dao.getAll(NotificationEntity.class);
        Assert.assertEquals(list.size(), 1);
    }
    ...
    public void testExecuteHereNot() throws Exception {
        ...
        Assert.assertEquals(1, MessageHandler.getQueue().size());
        Assert.assertEquals(MessageHandler.getQueue().peek().getMessage().getContent(), "Removed \"here\" from announces mentions !");
        list = dao.getAll(NotificationEntity.class);
        Assert.assertEquals(list.size(), 0);
    }
